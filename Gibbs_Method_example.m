...
% Gibbs Method example
close all; clear all; clc;
%% inputs
r1=[-294.32, 4265.1, 5986.7];   %  first position vector (1x3)
r2=[-1365.5, 3637.6, 6346.8];   %  second position vector (1x3)
r3=[-2940.3, 2473.7, 6555.8];   %  third position vector (1x3)
muo=398600; %  Gravitational Parameter
Re=6378;    % raduis of plant
%% Gibbs Solution
[ h, mag_h, i, omega, e_vector, mag_e, w, theta, rp, zp ] = Gibbs ( r1, r2, r3, muo, Re );
